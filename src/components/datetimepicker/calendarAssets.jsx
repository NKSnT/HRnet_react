...
export const CALENDAR_MONTHS_EN = {
    January: 'Jan',
    February: 'Feb',
    March: 'Mar',
    April: 'Apr',
...
export const CALENDAR_MONTHS_FR = {
    Janvier: 'Jan',
    Fevrier: 'Fev',
    Mars: 'Mar',
    Avril: 'Avr',
...
export default function Builder(month = THIS_MONTH, year = THIS_YEAR) {
